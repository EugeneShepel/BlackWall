...
export const filterSlice = createSlice({
  ...
  reducers: {
    resetExchangeFilters: () => exchangeFilters,
    exchangeVariants: (state, action) => state.filter((el) => el.from.code === action.payload),
  },
});

export const { resetExchangeFilters, exchangeVariants } = filterSlice.actions;
